...
public class MovieDAO_File implements IMovieDataAccess {
    ...
    private static final String MOVIES_FILE = "/Users/malthehager/Documents/INTELLIJ idea/MRS-starter-maven/data/movie_titles.txt";
    ...
    public List<Movie> getAllMovies()throws IOException {
        ...
        // Loop through all lines in the fil (List)
